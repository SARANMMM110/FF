...
console.log('🔄 Generating MySQL schema file from migrations...');
...
// First pass: Extract all TEXT columns from all tables across all migrations
const textColumns = new Map<string, Set<string>>(); // table -> set of TEXT column names

console.log('🔍 Analyzing table schemas to identify TEXT columns...');
...
for (const migration of migrationFiles) {
  console.log(`📄 Processing migration ${migration.number}...`);
...
console.log(`✅ MySQL schema file generated: ${outputPath}`);
console.log(`📦 You can now import this file to your MySQL database:`);
